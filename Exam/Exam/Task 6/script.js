...
const averageAgeParagraph = document.createElement('p');
averageAgeParagraph.textContent = 'Vidutinis amžius: ' + averageAge.toFixed(2);
const namesList = document.createElement('ol');
names.forEach(name => {
...
resultsDiv.appendChild(averageAgeParagraph);
